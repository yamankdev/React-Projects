...
function MobileFooter() {
  return (
    <footer className="text-white bg-zinc-900">
      <div className="flex justify-evenly gap-20 mx-auto py-5 text-[0.6rem]">
      ...
      {/* Brand logo and link to download the app */}
      ...
      <div className="flex flex-col py-4 bg-black text-white">
