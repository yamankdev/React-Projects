...
function MobileProduct() {
  ...
  return (
    <div className="flex lg:hidden flex-col gap-1 bg-gray-300 ">
      {/* Back, Search and Share */}
      <nav className="flex lg:hidden flex-col w-full bg-transparent hover:bg-white z-4 fixed">
      ...
      <div className="flex lg:hidden justify-between w-full p-2 mt-5 z-4 bg-white fixed bottom-0">
